...
import os
from AltClip.base_model import BaseModel

from .modeling_berts import BertSeriesConfig, RobertaSeriesConfig, BertSeriesModelWithTransformation, \
...
class CLIPHF(CLIPPreTrainedModel):
    ...
    def get_text_features(
        ...
        return text_features,text_outputs['last_hidden_state']
